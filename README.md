...
Upstream updates use the explicit revision in .upstream.json and the repo-patches candidate workflow. Review the generated patch on a feature branch before merging. Preserve the site overlay and existing tag data. Never force-replace master.
